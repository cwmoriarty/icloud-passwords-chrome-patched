...
var ValueSpecifier = function (e, r, t, n, a) {
    ...
    fieldLabelMap = {
        ...
        "adreça electrònica": new MapEntry(18, "adreça electrònica", valueSpecifiers[6]),
        ...
        "mobile number": new MapEntry(13, "mobile number", valueSpecifiers[16]),
        ...
        mobilenumber: new MapEntry(12, "mobilenumber", valueSpecifiers[16]),
...
const FormAutoFillKeywords = {
    ...
    ForgotEmailAffordanceRegularExpressions: ["^forgot.*email", "email?$"],
    ForgotUserNameAffordanceRegularExpressions: ["^forgot.*user.*name"],
    NonAccountPasswordSecureTextEntryFieldLabels: ["debit", "answer", "account number", "routing number"],
    ...
    IgnoredDataTypeFieldLabels: ["search", "social security", "socialsecurity", "ssn", "ssno", "ssnum", "airport", "gate code", "relationship"],
    NonAutoFillableFormTypeKeywords: ["import"],
    OldPasswordFieldLabels: ["current", "old", "original"],
    ConfirmEmailFieldLabels: ["confirm"],
    ConfirmPasswordFieldLabels: ["repeat", "retype", "confirm", "verify", "new"],
    ShowHideButtonLabels: ["show", "hide"],
    SearchFieldLabels: ["search"],
    NonUsernameFieldLabels: ["login code", "otpcode", "password", "captcha", "recaptcha", "sound", "answer", "confirmation code", "verification code", "zip code", "stock symbol", "chart", "table", "certificate", "cash card number"],
    PasswordFieldLabels: ["password", "passwd", "设置密码", "passwort"],
    ForgotPasswordAffordanceRegularExpressions: ["^forgot.*password"],
    NonEmailFieldLabels: ["確認コード"],
    UsernameFieldLabels: ["username", "user name", "screenname", "screen name", "loginname", "login name", "account name", "userID", "user ID", "loginID", "accountID", "Online ID", "GmailAddress", "Gmail Address", "usuario", "Library Card Number", "E-Mail-Adresse"],
    OneTimeCodeFieldLabels: ["security code", "login code", "enter the code", "enter code", "otp", "onetimecode", "onetimepasscode", "one time password", "one time passcode", "verification code", "verificationCode", "confirmation code", "identification code", "identificationCode", "activation code", "access code", "SMS", "digit code", "2fa", "twofactor", "two-factor", "two factor", "authentication code", "two step sign in", "two-step sign in", "MFA code", "sign-in code", "验证码", "校验码", "驗證碼", "驗証碼", "確認碼", "認證碼", "確認コード", "認証コード", "인증번호", "확인코드", "code de sécurité", "code de vérification", "code de validation", "code d'identification", "code d'authentification", "code d'autorisation", "code de confirmation", "code SMS de vérification", "Authorisierungscode", "Sicherheitscode", "Überprüfungscode", "Bestätigungscode", "Bestatigungscode", "Verifizierungscode", "Aktivierungscode", "Codice di sicurezza", "Codice attivazione", "codice di attivazione", "codice di conferma", "codice di verifica", "Kod bezpieczeństwa", "Kod autoryzacyjny", "Kod weryfikacyjny", "código de seguridad", "código de confirmación", "código de seguranca", "digite o codigo", "código de verificación", "código de verificação", "código de confirmacao", "Код проверки", "код безопасности", "код подтверждения", "Код аутентификации", "код підтвердження", "dogrulama kodu", "mã bảo mật", "Mã Xác Minh", "mã kích hoạt", "รหัสความปลอดภัย", "รหัสยืนยัน", "รหัสOTP", "รหัสการตรวจสอบยืนยัน", "รหัสการยืนยัน", "Kode keamanan", "Kode konfirmasi", "Kode verifikasi", "सत्यापन कोड", "Kod pengesahan", "Masukkan Kod", "Codul de confirmare"],
    WeakOneTimeCodeFieldLabels: ["code", "passcode", "PIN", "token", "código", "코드", "コード", "код"]
};
var FormMetadataJSControllerObject = function () {
    this.mapOfKeywordsIndicatingLoginFormTypeToScoreForMatching = FormAutoFillKeywords.LoginFormTypeKeywords, this.mapOfKeywordsIndicatingNewAccountFormTypeToScoreForMatching = FormAutoFillKeywords.NewAccountFormTypeKeywords, this.mapOfKeywordsIndicatingChangePasswordFormTypeToScoreForMatching = FormAutoFillKeywords.ChangePasswordFormTypeKeywords, this.keywordsIndicatingNonAutoFillableFormType = FormAutoFillKeywords.NonAutoFillableFormTypeKeywords, this.regularExpressionsForForgotPasswordAffordance = FormAutoFillKeywords.ForgotPasswordAffordanceRegularExpressions, this.regularExpressionsForForgotUserNameAffordance = FormAutoFillKeywords.ForgotUserNameAffordanceRegularExpressions, this.regularExpressionsForForgotEmailAffordance = FormAutoFillKeywords.ForgotEmailAffordanceRegularExpressions, this.shouldShowAdditionalUI = !0, this.nonUsernameFieldLabelPatternMatchers = function nonUsernameFieldLabelPatternMatchers() {
        ...
        return [new PatternMatcherClass(FormAutoFillKeywords.ConfirmEmailFieldLabels)]
    }(), this.oldPasswordFieldLabelPatternMatchers = function oldPasswordFieldLabelPatternMatchers() {
        return [new PatternMatcherClass(FormAutoFillKeywords.OldPasswordFieldLabels)]
    }(), this.usernameFieldLabelPatternMatchers = function usernameFieldLabelPatternMatchers() {
        return [new PatternMatcherClass(FormAutoFillKeywords.UsernameFieldLabels)]
        ...
        return [new PatternMatcherClass(FormAutoFillKeywords.ShowHideButtonLabels)]
        ...
        return [new PatternMatcherClass(FormAutoFillKeywords.OneTimeCodeFieldLabels)]
    }(), this.weakOneTimeCodeFieldLabelPatternMatchers = function weakOneTimeCodeFieldLabelPatternMatchers() {
        return [new PatternMatcherClass(FormAutoFillKeywords.WeakOneTimeCodeFieldLabels)]
    }(), this.ignoredDataTypeFieldLabelPatternMatchers = function ignoredDataTypeFieldLabelPatternMatchers() {
        return [new PatternMatcherClass(FormAutoFillKeywords.IgnoredDataTypeFieldLabels)]
    }(), this.searchFieldLabelPatternMatchers = function searchFieldLabelPatternMatchers() {
        return [new PatternMatcherClass(FormAutoFillKeywords.SearchFieldLabels)]
...
console.autofillDebugLog = function (e, ...r) {
    ...
    _stringsToInspectForDeterminingFormType: function (e) {
        ...
        let l = [];
        if (t.isVisible()) {
            const headerWithRectIsCloseEnoughToFormWithRect = function (e, r) {
                return r.left <= e.left && e.right <= r.right && e.distanceToRect(r) < 100 || e.left - r.left == r.right - e.right && e.distanceToRect(r) < 200
            };
            let e = t.getBoundingClientRect(),
                n = !1;
            for (let a = 0, i = t; a <= 2 && i; ++a, i = i.parentElementIncludingShadowDOMHost()) {
                let t = Array.prototype.slice.call(queryAllBySelector(i, "h1, h2, h3, [class*='header' i], [class*='heading' i]")),
                    a = [
                        [],
                        [],
                        [],
                ...
                for (headerElementsOfType of a) {
                    ...
                    headerWithRectIsCloseEnoughToFormWithRect(a.getBoundingClientRect(), e) && (r.push(a.innerText), n = !0);
                    break
                }
                if (o) break
            }
            if (!n) {
                ...
                if (1 === t.length) {
                    let n = t[0];
                    headerWithRectIsCloseEnoughToFormWithRect(n.getBoundingClientRect(), e) && r.push(n.innerText)
                }
            }
    ...
    _collectFormMetadata: function (e, r) {
        ...
        var O, R, N = this._identifyFormTypeAndPasswordFieldIndicesFromAutocompleteAttributes(y, h),
            D = N[0],
            q = N[1],
            z = N[2],
        ...
        if (void 0 !== j.PasswordFieldIndex && (S = h[j.PasswordFieldIndex], o.PasswordElementUniqueID = S.ControlUniqueID, g = this._explicitMaxLength(y[j.PasswordFieldIndex])), void 0 !== j.ConfirmationFieldIndex && (k = h[j.ConfirmationFieldIndex], o.ConfirmPasswordElementUniqueID = k.ControlUniqueID, C = this._explicitMaxLength(y[j.ConfirmationFieldIndex])), void 0 !== j.OldPasswordFieldIndex) {
            var W = h[j.OldPasswordFieldIndex];
            o.OldPasswordElementUniqueID = W.ControlUniqueID
        }
        if (S && (O = this._bestUsernameFieldCandidate(B, o, S)), O ? o.UsernameElementUniqueID = O.ControlUniqueID : R = this._findHiddenUsernameElement(e, o, B), D) o.AutoFillFormType = this._autoFillFormTypeFromCandidateFormTypes(e, D, D[0]);
        ...
        case 1:
            ...
            if (this._matchesConfirmPasswordFieldLabelPattern(y[0])) {
                let r = {};
                this._isElementFollowedByForgotPasswordAffordance(A, i) && (r[3] = 2), o.AutoFillFormType = this._autoFillFormTypeOfTypesUsingKeywordMatching(e, [4, 5], z || 3, r)
            } else {
                let r = y[0],
                    t = {},
        ...
        default:
            ...
            var V = y[0];
            if (this._matchesConfirmPasswordFieldLabelPattern(V, !0)) {
                let r = {};
                this._isElementFollowedByForgotPasswordAffordance(A, i) && (r[3] = 2), o.AutoFillFormType = this._autoFillFormTypeOfTypesUsingKeywordMatching(e, [3, 5], 5, r)
            } else if (this._matchesPasswordFieldLabelPattern(V))
                if (this._isElementFollowedByForgotPasswordAffordance(V, i)) o.AutoFillFormType = 3;
                else {
                    var H = [4, 3, 5];
                    o.AutoFillFormType = this._autoFillFormTypeOfTypesUsingKeywordMatching(e, H, 2), 2 === o.AutoFillFormType && R && (o.AutoFillFormType = 4)
                }
        ...
        if (1 === o.AutoFillFormType) {
            ...
            for (I = 0; I < $; ++I) {
                ...
                var Q = o.FormControls[I],
                    Z = Q.IsVisible;
                if (Z && Q.ControlIsTextField && X++, X > 1) break;
                var Y = this._isLabeledEmailField(A);
                if (Z && (Q.ControlClaimsToBeUsernameViaAutocompleteAttribute || Q.ControlIsLabeledUsernameField || Y || this._isLabeledLoginField(A)) && !this._matchesNonUsernameFieldLabelPattern(A) && !this._matchSearchFieldLabelPattern(A) && !A.readOnly && "INPUT" === A.tagName && !this._isLabeledSignUpField(A)) {
                    let r = {};
                    this._isElementFollowedByForgotUserNameOrEmailAffordance(A, i) && (r[3] = 2);
                    var ee = this._autoFillFormTypeOfTypesUsingKeywordMatching(e, [4, 3], Y ? 4 : 3, r);
                    3 === ee && (G = A, J = Q, K = ee)
                }
                ...
                if (r) {
                    const e = r.includes("username"),
                        ...
                        n = e && t,
                        a = e || Y;
                    (n || a) && (G = A, J = Q, K = n ? 3 : ee)
                }
            }
            1 === X && J && K && !controlAppearsToBePartOfPhotoTaggingInterface(G) && (o.AutoFillFormType = K, o.UsernameElementUniqueID = J.ControlUniqueID)
        }
        4 === o.AutoFillFormType && o.FirstCreditCardCardholderFieldOrCreditCardNumberFieldUniqueID === o.UsernameElementUniqueID && (o.UsernameElementUniqueID = void 0), !o.UsernameElementUniqueID && R && this._extractMetadataForHiddenUsernameElement(R, o, B), 3 != o.AutoFillFormType && 4 != o.AutoFillFormType && 5 != o.AutoFillFormType && (o.UsernameElementUniqueID = void 0, o.OldPasswordElementUniqueID = void 0, o.PasswordElementUniqueID = void 0, o.ConfirmPasswordElementUniqueID = void 0), o.IsVisible || 3 == o.AutoFillFormType || 4 == o.AutoFillFormType || 5 == o.AutoFillFormType || (o.AutoFillFormType = 2), 1 !== r && (o.TextSample = this._collectTextSample(e._formElement)), o.FormIsEligibleForAutomaticLogin = this._formIsEligibleForAutomaticLogin(o, e.backingElement);
        for (let e of o.FormControls)
            if (e.ControlLooksLikeOneTimeCodeField && this._oneTimeCodeIsEligibleForAutomaticLogin(e, o)) {
                ...
                break
            } var re = FormMetadataJSController.shouldIncludeNonEmptyFields;
        if (o.IsVisible)
            for (I = ($ = B.length) - 1; I >= 0; --I) this._shouldIncludeControlMetadata(re, o, B[I], o.FormControls[I]) || (4 !== r ? (o.FormControls.splice(I, 1), B.splice(I, 1)) : o.FormControls[I].WOULD_NORMALLY_NOT_BE_SENT_TO_UI_PROCESS = !0);
    ...
    textFieldOrSelectElementMetadata: function (e, r, t) {
        visibilityCacheGeneration++, this._removeUnparentedLogicalFormsFromCache();
        var n = [null, null],
            a = this._cachedMetadataForFormWithTextFieldOrSelectElement(e, r);
        if (!a) return n;
        this._pageScanContext = {
            backwardScanCache: new WeakMap,
            forwardScanCache: new WeakMap
        };
        let i = this._logicalFormWithID(a.FormID),
            o = formActionAsAnchorElement(i.formElement),
            [l, s, c, u] = this._trailingArgumentsForCollectControlMetadataFunction(i, r, o);
        var p = this._collectControlMetadata(e, 0, l, s, c, u, !0);
        if (delete this._pageScanContext, p.ControlLooksLikeOneTimeCodeField && this._oneTimeCodeIsEligibleForAutomaticLogin(p, a) && (p.OneTimeCodeIsEligibleForAutomaticLogin = !0), p.SelectionStart = e.selectionStart, p.SelectionLength = e.selectionEnd - e.selectionStart, 3 === r && (!a.UsernameElementUniqueID && this._isAnyPasswordElementUniqueID(a, p.ControlUniqueID) && i.isAnnotated && i.annotate({
                Username: null
            }), this._updateAnnotationsForField(e)), t) {
            for (const e of a.FormControls) e.ControlUniqueID == p.ControlUniqueID && (e.ControlValue = null);
            const e = JSON.stringify(a);
            this._cachedFormMetadata == e ? a = null : this._cachedFormMetadata = e
        }
        return n[0] = p, n[1] = a, n
    },
    ...
    autoFillOneTimeCodeFieldsWithValue: function (e, r) {
        ...
        if (this._isAutoFillableTextField(t)) {
            this._clearFormField(t);
            var n = e.split(""),
                a = n.length,
                i = function (t) {
                    if (t >= a) return void FormMetadataJSController.finishedAutoFillingOneTimeCode(e, r);
                    let o = innermostActiveElement();
                    var l = o.value + n[t];
                    this._autoFillControlWithValueAndOptions(o, l, ShouldFocusAndBlur.No, !0, !1), setTimeout(i, 0, t + 1)
                }.bind(this);
            i(0)
        }
    },
...
function pageNavigationHandler(e) {
    ...
    case 3:
        ...
        }))), humanReadableFormType(e), g_currentUserName = "", g_currentPassword = "";
        break;
    case 4:
    case 5:
...
function completionListBackgroundColor() {
    return window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches ? "rgba(35, 35, 35, 0.83)" : "rgba(230, 230, 230, 0.8)"
}
...
function showCompletionList(e, r) {
    ...
    g_completionListContainer.style.setProperty("top", c, "important"), g_completionListContainer.style.setProperty("left", u, "important"), g_completionListContainer.attachShadow({
        ...
        let r = e.getBoundingClientRect(),
            ...
            a = Math.round(r.x) + "px";
        t === c && a === u || (g_dateOfCompletionListAnchoringFieldFocusOrMovementOfThatField = new Date, g_completionListContainer.style.setProperty("top", t, "important"), g_completionListContainer.style.setProperty("left", a, "important"), c = t, u = a)
    }), 100)
}
